...
class Svgdisplay extends Component {
  ...
  render() {
    ...
    return (
      <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 535 688.7" preserveAspectRatio = "none" width="100%">
      ...
      <g id="WALLS_x5F_WINDOWS">
      	...
      	<rect id="WALL1" x="24.2" y="219.7" className="st2" width="8.6" height="390.5" onClick={this.handleClick}/>
      </g>
      ...
      <g id="Locations">
      	...
      	<rect id="3DFIL" x="288.8" y="264.4" className="st2" width="6.5" height="51" onClick={this.handleClick}/>
      	<rect id="DR3" x="19.6" y="33.7" className="st2" width="56.4" height="38" onClick={this.handleClick}/>
      	<rect id="DR2" x="19.6" y="71.7" className="st2" width="56.4" height="38.5" onClick={this.handleClick}/>
      	<rect id="DR1" x="19.6" y="110.2" className="st2" width="56.4" height="103.5" onClick={this.handleClick}/>
      	<rect id="FD" x="269.5" y="443.2" className="st2" width="37" height="39" onClick={this.handleClick}/>
      	<rect id="CR4" x="224" y="514.2" className="st2" width="6" height="51" onClick={this.handleClick}/>
      	<rect id="CR3" x="211.5" y="571.7" className="st2" width="18.5" height="38.5" onClick={this.handleClick}/>
      	<rect id="CR2" x="38.5" y="565.2" className="st2" width="24.5" height="45" onClick={this.handleClick}/>
      	<rect id="CR1" x="95" y="613.7" className="st2" width="135" height="29" onClick={this.handleClick}/>
      	<rect id="FL2" x="156.1" y="251.2" className="st2" width="12.6" height="224" onClick={this.handleClick}/>
      	<rect id="S2" x="149.8" y="251.2" className="st2" width="6.3" height="224" onClick={this.handleClick}/>
      	<rect id="FL1" x="130.3" y="251.2" className="st2" width="11.6" height="224" onClick={this.handleClick}/>
      	<rect id="S1" x="141.9" y="251.2" className="st2" width="6.5" height="224" onClick={this.handleClick}/>
      	<rect id="FL4" x="156.3" y="33.7" className="st2" width="12.6" height="180" onClick={this.handleClick}/>
      	<rect id="S4" x="150" y="33.7" className="st2" width="6.3" height="180" onClick={this.handleClick}/>
      	<rect id="FL3" x="130.6" y="33.7" className="st2" width="11.6" height="180" onClick={this.handleClick}/>
      	<rect id="S3" x="142.2" y="33.7" className="st2" width="6.5" height="180" onClick={this.handleClick}/>
      	...
      	<polygon id="HB2" className="st2" points="322.4,48.1 341.6,48.5 341.7,59.5 322.5,59.1 	" onClick={this.handleClick}/>
      	<rect id="HB1" x="309" y="322.2" className="st2" width="17.3" height="38.8" onClick={this.handleClick}/>
      ...
      <g id="text">
      	...
      	<text id="HB1" transform="matrix(1 0 0 1 309 343.1245)" className="st4 st7" onClick={this.handleClick}>HB1</text>
      	<text id="HB2" transform="matrix(1 0 0 1 324 56.9499)" className="st4 st7" onClick={this.handleClick}>HB2</text>
      	<text id="BEAM" transform="matrix(1 0 0 1 275.125 343.1247)" className="st4 st6" onClick={this.handleClick}>BEAM</text>
      	<text id="3DFILtext" transform="matrix(1 0 0 1 298.6122 292.6247)" className="st4 st6">3DFIL</text>
      	<text id="KIT2" transform="matrix(1 0 0 1 404.5 599.5417)" className="st4 st6" onClick={this.handleClick}>KIT2</text>
      	<text id="KIT1" transform="matrix(1 0 0 1 353 633.7917)" className="st4 st6" onClick={this.handleClick}>KIT1</text>
      	...
      	<text id="9text" transform="matrix(1 0 0 1 401.5 369.3799)" className="st4 st7">9</text>
      	<text id="8text" transform="matrix(1 0 0 1 418.75 222.6965)" className="st4 st7">8</text>
      	<text id="7text" transform="matrix(1 0 0 1 402 222.6965)" className="st4 st7">7</text>
      	<text id="6text" transform="matrix(1 0 0 1 300.3878 266.6964)" className="st4 st7">6</text>
      	<text id="5text" transform="matrix(1 0 0 1 270.375 266.6964)" className="st4 st7">5</text>
      	<text id="4text" transform="matrix(1 0 0 1 153.0833 221.9465)" className="st4 st7">4</text>
